...
$(function() {
    ...
    var CLASSES = {
        ...
        ACTIVE_PIP_CLASS: 'carousel-pip_isActive',
        INACTIVE_PIP_CLASS: 'carousel-pip_isInactive'
    };
    ...
    Carousel.prototype.createChildren = function() {
        ...
        this.$pips = $('.carousel-pips').children();
        this.$currentPip = this.$pips.eq(this.currentIndex);
        ...
        // // Make first pip active
        this.$currentPip.addClass(CLASSES.ACTIVE_PIP_CLASS);

        // // Make all pips but the first inactive
        this.$pips.not(this.$currentPip).addClass(CLASSES.INACTIVE_PIP_CLASS);
    ...
    Carousel.prototype.goToSlide = function(index) {
        ...
        this.$currentPip
            .removeClass(CLASSES.ACTIVE_PIP_CLASS)
            .addClass(CLASSES.INACTIVE_PIP_CLASS);

        this.$currentPip = this.$pips.eq(index);

        this.$currentPip
            .removeClass(CLASSES.INACTIVE_PIP_CLASS)
            .addClass(CLASSES.ACTIVE_PIP_CLASS);
    ...
    $('.carousel-button-left').click(function () {
        newCarousel.goToPreviousSlide();
    });

    $('.carousel-button-right').click(function () {
        newCarousel.goToNextSlide();
    });

    // Bonus clicky pips
    $('.carousel-pips > p').click(function (event) {
        newCarousel.goToSlide($('.carousel-pips > p').index(event.target));
    })
